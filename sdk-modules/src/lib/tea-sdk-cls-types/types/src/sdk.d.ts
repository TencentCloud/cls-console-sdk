...
declare const SdkApi: {
  ...
  SearchPage: {
    SearchPageComponent: import('react').ForwardRefExoticComponent<
      import('./sdk/SearchPage/SdkSearchPage').ISdkSearchPageProps & import('react').RefAttributes<any>
    >;
  };
  /** 仪表盘页面 */
  DashboardPage: {
    DashboardPageComponent: import('react').ForwardRefExoticComponent<
      import('./sdk/DashboardPage/SdkDashboardPage').ISdkDashboardPageProps & import('react').RefAttributes<any>
    >;
  };
  /** DataSight管理组件 */
  DataSight: {
