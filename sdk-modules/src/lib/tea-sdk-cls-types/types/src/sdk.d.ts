...
declare const SdkApi: {
    ...
    /** 检索分析页 */
    SearchPage: {
        SearchPageComponent: import("react").ForwardRefExoticComponent<import("./sdk/SearchPage/SdkSearchPage").ISdkSearchPageProps & import("react").RefAttributes<any>>;
    };
    /** 仪表盘页面 */
    DashboardPage: {
        DashboardPageComponent: import("react").ForwardRefExoticComponent<import("./sdk/DashboardPage/SdkDashboardPage").ISdkDashboardPageProps & import("react").RefAttributes<any>>;
    };
};
